"""
Альтернативная версия main.py для Windows
Использует cluster-windows.py вместо cluster.py
"""
...
# API endpoints (остальные endpoints остаются такими же, как в main.py)
